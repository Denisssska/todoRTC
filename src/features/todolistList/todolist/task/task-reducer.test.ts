...
test('remove task', () => {
    const endState = taskReducer(startState, removeTaskAC({id,todolistId:todolistId1}))
...
test('add task', () => {
    ...
    const endState = taskReducer(startState, addTaskAC({item:newTitle,todolistId:todolistId1}))
...
test('change task status', () => {
    ...
    let status = 1
    const endState = taskReducer(startState, updateTaskAC({taskId:id,payLoad:{status},todolistId:todolistId1}))
...
test('change task text', () => {
    let id = startState.tasks[1].id
    let title = 'Super'
    const endState = taskReducer(startState, updateTaskAC({taskId:id,payLoad:{title},todolistId:todolistId1}))
